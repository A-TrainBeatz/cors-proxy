...
const BACKEND = '/proxy?url='; // relative path to proxy endpoint
...
async function handleRequest(req){
  try {
    ...
    return new Response('<body style="font-family:sans-serif;color:#bbb;"><h3>Offline / Network Error</h3></body>', {headers:{'Content-Type':'text/html'}});
  }
}
